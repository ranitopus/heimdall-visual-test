 ...
 * @description It can return one of the posibilities as a result:
 ...
 * - The pixels generated by this function can be used to construct a new image to visualize in the same place the differences and similarities
 */
